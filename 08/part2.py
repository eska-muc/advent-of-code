        ...
        for i in range(0,len(tuples)):
            for j in range(0,len(tuples)):
                if i!=j :
                    ...
                    print(f"Pair {k} {i}({x1},{y1}) {j}({x2},{y2}) => {xdiff} {ydiff} a1 ({a1x},{a1y}) a2 ({a2x},{a2y})")
                    # additional antinodes for part 2
                    inboundary = True
                    sx = x2
                    sy = y2
                    while inboundary:
                        ...
                        sx = xn
                        sy = yn
                        inboundary = checkandsetantinode(map,antinodemap,k,xn,yn)
                        if inboundary:
                            print(f" additional anti node {k} {xn},{yn}")
